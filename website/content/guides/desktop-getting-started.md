...
@capture-alt: Nextcloud Native desktop Settings workspace with account, appearance, sync and storage, desktop app, updates, support, help, and administration sections
