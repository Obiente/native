export const guidePlatformHubs = [
  {
    ...
    label: "Android",
    device: "Mobile",
    title: "Nextcloud Native guides for Android",
    description:
      "Set up Nextcloud Native on Android, keep files available offline, sync device folders, back up media, and use Calendar with phone-specific instructions.",
    summary:
  ...
  },
  {
    ...
    label: "Desktop",
    device: "Desktop",
    title: "Nextcloud Native desktop guides",
    description:
      "Use Nextcloud Native on Linux and Windows with desktop navigation, folder sync, native file integration, and platform-specific setup guidance.",
    summary:
  ...
  },
  {
    ...
    label: "Linux",
    device: "Desktop",
    title: "Nextcloud Native guides for Linux",
    description:
      "Install and use Nextcloud Native on Linux, configure desktop folder sync, and understand Secret Service and filesystem integration in the current alpha.",
    summary:
  ...
  },
  {
    ...
    label: "Windows",
    device: "Desktop",
    title: "Nextcloud Native guides for Windows",
    description:
      "Install the Nextcloud Native Windows alpha safely and use Credential Manager and Cloud Files placeholders in File Explorer.",
    summary:
