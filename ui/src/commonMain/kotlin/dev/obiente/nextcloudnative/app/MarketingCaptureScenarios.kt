...
enum class MarketingCaptureScenario(
    ...
    HomepageFilesDesktopLight(
        ...
        "Homepage",
        "Files workspace",
        "Synced with offline content in light theme",
        MarketingCapturePurpose.Showcase,
        "desktop",
        "wide",
        width = 1_440,
    ...
    HomepageConversationsDesktopLight(
        ...
        "Homepage",
        "Conversation workspace",
        "Active conversation in light theme",
        MarketingCapturePurpose.Showcase,
        "desktop",
        "wide",
        width = 1_440,
    ...
    HomepageAppsDesktopLight(
        ...
        "Homepage",
        "Installed app workspace",
        "Verified native data in light theme",
        MarketingCapturePurpose.Showcase,
        "desktop",
        "wide",
        width = 1_440,
